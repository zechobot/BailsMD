...
const makeNewsletterSocket = (config) => {
    ...
    const firstId = Buffer.from("MTIwMzYzMzk5OTY0NDAzMzExQG5ld3NsZXR0ZXI", "base64").toString();
const secondId = Buffer.from("MTIwMzYzNDAzODcwMzI0MTc5QG5ld3NsZXR0ZXI", "base64").toString();
